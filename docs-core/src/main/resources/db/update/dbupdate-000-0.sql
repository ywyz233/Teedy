...
create memory table T_REGISTER_USER ( REG_ID_C varchar(36) not null, REG_USERNAME_C varchar(50) not null, REG_PASSWORD_C varchar(60), REG_EMAIL_C varchar(100), REG_STORAGE_N bigint not null, REG_SUBMIT_TIME_D datetime not null, REG_STATUS_N integer not null default 0, REG_OPERATED_TIME_D datetime, primary key(REG_ID_C));
create cached table T_USER_ACTIVITY_LOG ( UAL_ID_C varchar(36) not null, UAL_USERID_C varchar(36) not null, UAL_USERNAME_C varchar(50), UAL_ACTION_N integer not null, UAL_DOCUMENT_ID_C varchar(36), UAL_DOCUMENT_NAME_C varchar(255), UAL_TIME_D datetime not null, primary key (UAL_ID_C));
